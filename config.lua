...
Config.BleedoutTimer              = 600000 * 1 -- time til the player bleeds out
...
Config.RespawnPoints = {
	{coords = vector3(892.1546, -77.8514, 78.7641), heading = 205.9536} --Spawnpoint Bloods
	--{coords = vector3(-53.5006, -1848.0990, 26.3326), heading = 15.0919} --Spawnpoint Groove street
	--{coords = vector3(213.5665, -2023.0322, 18.3936), heading = 294.7272} --Spawnpoint James Town
	--{coords = vector3(858.7916, -2222.7063, 30.4872), heading = 31.4205} --Spawnpoint Meat Factory
	--{coords = vector3(908.8149, -136.6162, 76.5703), heading = 351.0000} --Spawnpoint Bloods
	--{coords = vector3(908.8149, -136.6162, 76.5703), heading = 351.0000} --Spawnpoint Bloods
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(315.6178, -590.3642, 43.2841),
